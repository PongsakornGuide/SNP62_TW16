...
////  SNP_TW16
////
////  Created by Pongsakorn Piya-ampornkul on 7/4/2563 BE.
...
//            let label = UILabel()
//        let title = "ทำการสมัครสมาชิกเรียบร้อย"
//            let style = NSMutableParagraphStyle()
//            style.alignment = NSTextAlignment.center
...
//            submit.addTarget(self, action: #selector(TestCheckBoxTableView.actionRegister), for: .touchUpInside)
//            return submit
//    }()
//    
//    
...
//        
//        
//        bgImageProfile.anchor(view.safeAreaLayoutGuide.topAnchor, left: view.safeAreaLayoutGuide.leftAnchor, right: view.safeAreaLayoutGuide.rightAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, topConstant: 130, bottomConstant: 130, leftConstant: 40, rightConstant: 40, widthConstant: 0, heightConstant: 0)
//        
