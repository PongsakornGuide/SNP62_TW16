...
class ProfileVIewController: UIViewController{
    ...
    let profileImageView : UIImageView = {
             let image = UIImageView()
                   ...
                   image.layer.cornerRadius = 158/2
...
//          }()
    ...
    let activityUser : UIButton = {
        ...
        func getImage(){
              if let name3 = defaultValues.string(forKey: "ImageUser") {
                ImageProfiles = name3
                Alamofire.request("http://localhost/alder_iosapp/" + (ImageProfiles ?? "0")!).responseImage { response in
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(dataUser)
        view.addSubview(nameHeader)
        view.addSubview(surnameHeader)
        
        view.addSubview(postUser)
        view.addSubview(activityUser)
        view.addSubview(iconNursingHome)
        view.addSubview(nursingHome)
        view.addSubview(line)
        view.addSubview(birthday)
        view.addSubview(iconbirthday)
        view.addSubview(tel)
        view.addSubview(icontel)
        
        view.addSubview(iconPost)
//        view.addSubview(titlePost)
        
        view.addSubview(iconActivity)
//        view.addSubview(activityPost)
        ...
        bgImageView.anchor(view.safeAreaLayoutGuide.topAnchor, left: view.safeAreaLayoutGuide.leftAnchor, right: view.safeAreaLayoutGuide.rightAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, topConstant: 50, bottomConstant: 20, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 500)
        
        profileImageView.anchor(bgImageView.topAnchor, left: bgImageView.leftAnchor, right: bgImageView.rightAnchor, bottom: nil, topConstant: 0, bottomConstant: 0, leftConstant: 110, rightConstant: 110, widthConstant: 150, heightConstant: 155)
        
        ImageProfile.anchor(profileImageView.topAnchor, left: bgImageView.leftAnchor, right: bgImageView.rightAnchor, bottom: nil, topConstant: 7, bottomConstant: 0, leftConstant: 117, rightConstant: 117, widthConstant: 142, heightConstant: 142)
               
        
        editProfile.anchor(profileImageView.bottomAnchor, left: bgImageView.leftAnchor, right: bgImageView.rightAnchor, bottom: nil, topConstant: -10, bottomConstant: 0, leftConstant: 100, rightConstant: 100, widthConstant: 0, heightConstant: 100)
    
        
        dataUser.anchor(editProfile.bottomAnchor, left: bgImageView.leftAnchor, right: bgImageView.rightAnchor, bottom: nil, topConstant: -10, bottomConstant: 0, leftConstant: 10, rightConstant: 10, widthConstant: 0, heightConstant: 280)
          
        nameHeader.anchor(dataUser.topAnchor, left: dataUser.leftAnchor, right: nil, bottom: nil, topConstant: 30, bottomConstant: 0, leftConstant: 25, rightConstant: 0, widthConstant: 0, heightConstant: 50)
        
        
        surnameHeader.anchor(dataUser.topAnchor, left: nil, right: dataUser.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 0, leftConstant: 30, rightConstant: 25, widthConstant: 0, heightConstant: 50)
        ...
        postUser.anchor(dataUser.bottomAnchor, left: bgImageView.leftAnchor, right: nil, bottom: nil, topConstant: 20, bottomConstant: 0, leftConstant: 10, rightConstant: 10, widthConstant: 168, heightConstant: 120)
...
//        titlePost.anchor(iconPost.topAnchor, left: postUser.leftAnchor, right:nil, bottom: nil, topConstant: 40, bottomConstant: 0, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 50)

    
        
        activityUser.anchor(dataUser.bottomAnchor, left: nil, right: bgImageView.rightAnchor, bottom: nil, topConstant: 20, bottomConstant: 0, leftConstant: 0, rightConstant: 10, widthConstant: 168, heightConstant: 120)
...
//
//        activityPost.anchor(iconActivity.topAnchor, left: activityUser.leftAnchor, right:nil, bottom: nil, topConstant: 40, bottomConstant: 0, leftConstant: 10, rightConstant: 0, widthConstant: 0, heightConstant: 50)
