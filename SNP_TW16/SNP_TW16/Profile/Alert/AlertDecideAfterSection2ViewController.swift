//
//  AlertDecideAfterSection2ViewController.swift
//  SNP_TW16
//
...
class AlertDecideAfterSection2ViewController: UIViewController {
    ...
    lazy var titleLabel : UILabel = {
     ...
     var postUser : UIButton = {
            ...
            submit.addTarget(self, action: #selector(DecideChoiceViewController.actionJoin), for: .touchUpInside)
            return submit
    }()
