...
class AlertCheckChoice: UIViewController {
    ...
    lazy var titleHeader1 : UILabel = {
     ...
     var postUser : UIButton = {
            ...
            submit.addTarget(self, action: #selector(DecideAfterViewController.cancelError), for: .touchUpInside)
            return submit
    }()
