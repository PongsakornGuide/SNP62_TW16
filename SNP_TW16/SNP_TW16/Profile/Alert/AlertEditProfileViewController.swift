//
//  AlertEditProfileViewController.swift
//  SNP_TW16
//
...
class AlertEditProfileViewController: UIViewController {
    ...
    lazy var titleHeader : UILabel = {
     ...
     var postUser : UIButton = {
            ...
            submit.addTarget(self, action: #selector(editProfileView.actionJoin), for: .touchUpInside)
            return submit
    }()
