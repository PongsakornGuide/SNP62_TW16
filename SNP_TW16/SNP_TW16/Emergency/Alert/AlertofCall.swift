...
class AlertofCall: UIViewController {
    ...
    lazy var titleHeader1 : UILabel = {
     ...
     static var postUser : UIButton = {
            ...
            submit.addTarget(self, action: #selector(EmergencyViewController.actionCall), for: .touchUpInside)
            return submit
    }()
    ...
    super.viewDidLoad()
        ...
        view.addSubview(AlertofCall.postUser)
        ...
        AlertofCall.postUser.anchor(titleHeader1.bottomAnchor, left: bgImageProfile.leftAnchor, right: bgImageProfile.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 30, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 60)
        
        cancel.anchor(AlertofCall.postUser.bottomAnchor, left: bgImageProfile.leftAnchor, right: bgImageProfile.rightAnchor, bottom: bgImageProfile.bottomAnchor, topConstant: 20, bottomConstant: 30, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 60)
