...
class AlertCallofUser: UIViewController {
    ...
    lazy var titleHeader1 : UILabel = {
     ...
     static var postUser : UIButton = {
            ...
            submit.addTarget(self, action: #selector(EmergencyViewController.actionCallUser), for: .touchUpInside)
            return submit
    }()
    ...
    static var deletebtn : UIButton = {
               let submit = UIButton(type: UIButton.ButtonType.system)
               submit.setTitle("ลบเบอร์", for: .normal)
               submit.setTitleColor(UIColor.red,for: .normal)
               submit.titleLabel?.font = UIFont.BaiJamjureeBold(size: 22)
        submit.addTarget(self, action: #selector(EmergencyViewController.deleteUser), for: .touchUpInside)
               return submit
    }()
...
//      }
    ...
    super.viewDidLoad()
        ...
        view.addSubview(AlertCallofUser.postUser)
        view.addSubview(cancel)
        view.addSubview(AlertCallofUser.deletebtn)
        
        
        bgImageProfile.anchor(nil, left: view.safeAreaLayoutGuide.leftAnchor, right: view.safeAreaLayoutGuide.rightAnchor, bottom: AlertCallofUser.deletebtn.bottomAnchor, topConstant: 0, bottomConstant: 0, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 0)
        ...
        titleHeader.anchor(iconImage.bottomAnchor, left: bgImageProfile.leftAnchor, right: bgImageProfile.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 10, leftConstant: 10, rightConstant: 10, widthConstant: 0, heightConstant: 0)
        ...
        AlertCallofUser.postUser.anchor(titleHeader1.bottomAnchor, left: bgImageProfile.leftAnchor, right: bgImageProfile.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 30, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 60)
        
        cancel.anchor(AlertCallofUser.postUser.bottomAnchor, left: bgImageProfile.leftAnchor, right: bgImageProfile.rightAnchor, bottom: nil, topConstant: 20, bottomConstant: 30, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 60)
        
        AlertCallofUser.deletebtn.anchor(cancel.bottomAnchor, left: bgImageProfile.leftAnchor, right: bgImageProfile.rightAnchor, bottom: bgImageProfile.bottomAnchor, topConstant: 20, bottomConstant: 30, leftConstant: 20, rightConstant: 20, widthConstant: 0, heightConstant: 40)
