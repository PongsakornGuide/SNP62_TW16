...
class EmergencyView: UITableViewCell {
    ...
    let btnEmergency : UIButton = {
        ...
        btn.layer.borderColor = UIColor.blackAlpha(alpha: 0.2).cgColor
    ...
    func setLayout(){
        ...
        btnEmergency.anchor(bgImage.bottomAnchor, left: leftAnchor, right: rightAnchor, bottom: nil, topConstant: -50, bottomConstant: 0, leftConstant: 90, rightConstant: 90, widthConstant: 0, heightConstant: 190)
