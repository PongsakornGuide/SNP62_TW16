...
//              bg.layer.shouldRasterize = true
           ...
           func setLayout(){
            ...
            ImageView.anchor(bgEmergency.topAnchor, left: bgEmergency.leftAnchor, right: nil, bottom: nil, topConstant: 20, bottomConstant: 10, leftConstant: 20, rightConstant: 0, widthConstant: 50, heightConstant: 50)

            title.anchor(bgEmergency.topAnchor, left: ImageView.rightAnchor, right: ImageCall.leftAnchor, bottom: bgEmergency.bottomAnchor, topConstant: 18, bottomConstant: 20, leftConstant: 25, rightConstant:25, widthConstant: 0, heightConstant: 55)
                    title.widthAnchor.constraint(lessThanOrEqualToConstant: screenSizeX).isActive = true
                    
            ImageCall.anchor(bgEmergency.topAnchor, left: nil, right: bgEmergency.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 30, leftConstant: 25, rightConstant: 25, widthConstant: 30, heightConstant: 30)
