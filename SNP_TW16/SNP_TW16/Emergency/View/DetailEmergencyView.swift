...
class DetailEmergencyView: UITableViewCell {
    ...
    //
            ImageView.anchor(bgEmergency.topAnchor, left: bgEmergency.leftAnchor, right: nil, bottom: nil, topConstant: 10, bottomConstant: 10, leftConstant: 15, rightConstant: 0, widthConstant: 50, heightConstant: 50)

            title.anchor(bgEmergency.topAnchor, left: ImageView.rightAnchor, right: ImageCall.leftAnchor, bottom: bgEmergency.bottomAnchor, topConstant: 20, bottomConstant: 20, leftConstant: 25, rightConstant:25, widthConstant: 0, heightConstant: 0)
