...
class HeaderActivity: UITableViewCell {
     override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
       ...
       func setupViewCell(){
        ...
        titleType.anchor(bgEmergency.topAnchor, left: iconImage.rightAnchor, right: bgEmergency.rightAnchor, bottom: bgEmergency.bottomAnchor, topConstant: 20, bottomConstant: 20, leftConstant: 30, rightConstant: 30, widthConstant: 0, heightConstant: 0)
