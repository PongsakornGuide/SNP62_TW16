...
import UIKit
class HeaderMusic: UITableViewCell {
     override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
       ...
       func setupViewCell(){
           ...
           titleType.anchor(bgEmergency.topAnchor, left: iconImage.rightAnchor, right: bgEmergency.rightAnchor, bottom: nil, topConstant: 35, bottomConstant: 30, leftConstant: 30, rightConstant: 30, widthConstant: 0, heightConstant: 0)
