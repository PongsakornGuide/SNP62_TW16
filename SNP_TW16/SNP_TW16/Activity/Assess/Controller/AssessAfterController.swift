...
//                   title.text = "กรุณาทำแบบประเมินหลังเข้าร่วมกิจกรรม"
//                   title.textColor = UIColor.black
...
//                  title.lineBreakMode = .byWordWrapping
//                  title.numberOfLines = 5
//                 title.text = "1. หลังจากเข้าร่วมกิจกรรม ท่านมีความรู้สึกอย่างไร"
//                 title.textColor = UIColor.black
...
//             }()
//         //-----------------------------------------------------------------------------------------------
//         let contenDeatil2 : UILabel = {
//                let title = UILabel()
//                 title.lineBreakMode = .byWordWrapping
//                 title.numberOfLines = 5
//                title.text = "2. ท่านสนใจที่จะเข้าร่วมกิจกรรมที่จัดขึ้นในครั้งต่อไปอีกหรือไม่"
//                title.textColor = UIColor.black
//                title.font = UIFont.PoppinsMedium(size: 19)
//                return title
//          }()
...
//                     button.setTitle("ส่งประเมิณ", for: .normal)
...
//                    viewScroll.addSubview(contenDeatil2)
...
//                    //
//                    
//                    bgcheck.anchor(contenDeatil.bottomAnchor, left: BGView.leftAnchor, right: BGView.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 0, leftConstant: 20, rightConstant: 20, widthConstant: screenSizeX, heightConstant: 50)
//                    
...
//                    
//                    //
//                    contenDeatil2.anchor(bgcheck3.bottomAnchor, left: BGView.leftAnchor, right: BGView.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 20, leftConstant: 30, rightConstant: 30, widthConstant: screenSizeX, heightConstant: 20)
//                    
//                    
//                    bgcheck4.anchor(contenDeatil2.bottomAnchor, left: BGView.leftAnchor, right: BGView.rightAnchor, bottom: nil, topConstant: 30, bottomConstant: 0, leftConstant: 20, rightConstant: 20, widthConstant: screenSizeX, heightConstant: 50)
//                    
