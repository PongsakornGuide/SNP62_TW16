...
class AlertJoinViewController: UIViewController {
    ...
    lazy var titleHeader : UILabel = {
     ...
     var postUser : UIButton = {
            ...
            submit.addTarget(self, action: #selector(ContentActivityViewController.actionJoin), for: .touchUpInside)
            return submit
    }()
