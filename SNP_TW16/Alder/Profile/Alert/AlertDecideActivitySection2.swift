//
//  AlertDecideActivitySection2.swift
//  SNP_TW16
//
...
class AlertDecideActivitySection2: UIViewController {
    ...
    lazy var iconImage : UIImageView = {
        ...
        image.image = UIImage(named: "Group 1661")
    ...
    lazy var titleLabel : UILabel = {
        let label = UILabel()
        let title = "จึงขออนุญาตทราบสาเหตุเพิ่มเติม"
        let style = NSMutableParagraphStyle()
        style.alignment = NSTextAlignment.center
    ...
    var postUser : UIButton = {
        ...
        submit.addTarget(self, action: #selector(DecideAfterViewController.section2), for: .touchUpInside)
        return submit
    }()
