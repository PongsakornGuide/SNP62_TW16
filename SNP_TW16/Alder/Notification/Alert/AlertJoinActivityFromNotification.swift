//
//  AlertJoinActivityFromNotification.swift
//  SNP_TW16
//
...
class AlertJoinActivityFromNotification: UIViewController {
    ...
    lazy var titleHeader : UILabel = {
     ...
     var postUser : UIButton = {
            ...
            submit.addTarget(self, action: #selector(NotificationContent.actionJoin), for: .touchUpInside)
            return submit
    }()
