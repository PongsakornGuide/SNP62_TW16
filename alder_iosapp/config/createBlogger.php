...
<body style="background:#fff;">
  ...
  <div class="page-inner no-page-title">
       <div id="main-wrapper">
           <h2 style="font-family: 'Bai Jamjuree', sans-serif; font-weight: bold;">สร้างบทความศาสนา &nbsp;<i class="far fa-newspaper"></i></h2>
           ...
           <div class="card mt-2 col-lg-12" style="margin-top: 30px !important; border-radius:15px;">
               <div class="card-body" style="font-family: 'Bai Jamjuree', sans-serif;">
                   ...
                   <form action="../func/createBlogger.php" method="post" enctype="multipart/form-data">
                       ...
                       <div class="row col-12">
                           <div class="form-group col-12">
                               ...
                               <input class="form-control" name="credit" type="text" id="credit" placeholder="ชื่อผู้แต่ง">
                           </div>
                       </div>
                       ...
                       <div>
                           <input class="btn offset-10 mt-5" style="background: #419F5D; color:#fff" type="submit" value="บันทึกข้อมูล">
                       </div>
                   </form>
