...
<body>
  ...
  <div class="page-inner no-page-title" style="background:#fff;">
    <div id="main-wrapper">
      ...
      <h2 class="mt-4" style="font-family: 'Bai Jamjuree', sans-serif; font-weight: bold;font-size:40px;color:#1B4793;">กิจกรรมสันทนาการ&nbsp;<img class="mr-3 mb-2" src="../images/activity -1 – 1.png" style="width: 35px;"></h2>
      <br>
      <hr>
      <br>
      ...
      <div>
        <?php
                  ...
                  $sql = "SELECT * FROM post_timelines WHERE post_timelines.act_id = 1 ORDER BY id DESC";
