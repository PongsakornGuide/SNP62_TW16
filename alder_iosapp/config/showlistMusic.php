...
<body>
  ...
  <div class="page-inner no-page-title" style="background:#fff;">
    <div id="main-wrapper">
      ...
      <h2 class="mt-4" style="font-family: 'Bai Jamjuree', sans-serif; font-weight: bold;font-size:40px;color:#1B4793;">LIST MUSIC&nbsp; <i class="fas fa-music" style="font-size:35px;"></i> </h2>
      <br>
      <hr>
      <br>
      <div>
