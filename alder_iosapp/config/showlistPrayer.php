...
<body>
  ...
  <div class="page-inner no-page-title" style="background:#fff;">
    <div id="main-wrapper">
      ...
      <h2 class="mt-4" style="font-family: 'Bai Jamjuree', sans-serif; font-weight: bold;">บทสวดธรรมมะ&nbsp;</h2>
      <br>
      <hr>
      <br>
      <div>
            ...
            <div class="col-lg-4">
              <a href="/alder_iosapp/config/showDetailstory.php?id=<? echo $row['id']?>">
                <div class="card">
                  ...
                  <hr>
                  <div class="row">
                    <p class="card-text col-5" style="margin-bottom: 15px; margin-left: 20px; color:#A7A9AC">โดย : <?php echo $row['credit'] ?></p>
