				...
				<div class="card-body" style="font-family: 'Bai Jamjuree', sans-serif;">
					...
					<form id="myForm" action="../func/saveVideo.php" method="post" enctype="multipart/form-data">
						...
						<div class="row col-12">
							...
							<div class="form-group col-6">
								<label for="exampleFormControlSelect2" style="font-weight:bold;">url</label>
								<input class="form-control" id="url" name="url" value="<?php echo $result["url"];?>">
							</div>

							<div class="form-group col-12 mt-4">
								<iframe width="100%" height="400" src="https://www.youtube.com/embed/<?php echo $result["url"];?>">
								</iframe>
							</div>
							...
							<div class="form-group col-12 mt-2">
								<div style="float:right;">
									...
									<button class="submit" type="submit" style="background: #FAC92C;color:#fff;font-family: 'Bai Jamjuree', sans-serif; font-weight: 700;padding:12px;border-radius:5px;border:none;"><i class="fas fa-user-edit"></i> แก้ไขวิดีโอ</button>&nbsp;&nbsp;
									<a class="btnbtn btn-danger" href="../func/deleteVideo.php?delete=<?php echo $result["id"];?>" style="background: #FAC92C;color:#fff;font-family: 'Bai Jamjuree', sans-serif; font-weight: 700;padding:14px;border-radius:5px;color:#fff;">
