...
if (!verifyRequiredParams(array('user_id','ad_post_timeline_id','comment_id'))) {
    $user_id = $_POST["user_id"];
    $ad_post_timeline_id = $_POST["ad_post_timeline_id"];
    $comment_id = $_POST["comment_id"];
    $sql = "INSERT INTO likeActivityComment (user_id,ad_post_timeline_id,comment_id) VALUES ('$user_id','$ad_post_timeline_id','$comment_id')";
