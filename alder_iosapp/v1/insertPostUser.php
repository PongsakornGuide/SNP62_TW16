...
if (!verifyRequiredParams(array('ad_post_timeline_id', 'user_id','other_id'))) {

    $ad_post_timeline_id = $_POST["ad_post_timeline_id"];
    $user_id = $_POST["user_id"];
    $other_id = $_POST["other_id"];

    $sql = "INSERT INTO notificationsPost (ad_post_timeline_id, user_id,other_id) VALUES ('$ad_post_timeline_id','$user_id','$other_id')";
