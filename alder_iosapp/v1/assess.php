...
if (!verifyRequiredParams(array('user_id', 'post_timeline_id' , 'feel_id'))) {
    $user_id = $_POST["user_id"];
    $post_timeline_id = $_POST["post_timeline_id"];
    $feel_id =  $_POST["feel_id"];

    $sql = "INSERT INTO decide (user_id, post_timeline_id,feel_id) VALUES ('$user_id','$post_timeline_id','$feel_id')";
