...
if (!verifyRequiredParams(array('id','ad_post_timeline_id', 'user_id'))) {
    $id = $_POST["id"];
    $ad_post_timeline_id = $_POST["ad_post_timeline_id"];
    $user_id = $_POST["user_id"];
    $sql = "DELETE FROM comments WHERE (id,ad_post_timeline_id,user_id) = ('$id','$ad_post_timeline_id','$user_id')";
